...
public class Utilities {
	...
	public static String genetateEmailWithTimeStamp() {
		Date date=new Date();
	...
	public static String captureScreenshot(WebDriver driver,String testName) {
		...
		String destinationScreenshotPath=System.getProperty("user.dir")+"\\Screenshots\\"+testName+" "+Utilities.generateTimeStamp()+".png";
		try {
